...
const isValidWhiteSpace = (glyphString, codePoint, index) => (
	glyphString.isWhiteSpace(index) && codePoint !== NO_BREAK_SPACE_DECIMAL
);

const getWhiteSpaceId = glyph => (
	glyph._font.layout(' ').glyphs[0].id
)
